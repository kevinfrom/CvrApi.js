...
var CvrApi = /** @class */ (function () {
    ...
    CvrApi.prototype.search = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(query))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    CvrApi.prototype.searchByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(name, 'name'))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    CvrApi.prototype.searchByVat = function (vat) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(vat, 'vat'))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    CvrApi.prototype.searchByCvr = function (cvr) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(cvr, 'vat'))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    CvrApi.prototype.searchByProductionUnit = function (productionUnit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(productionUnit, 'produ'))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
    ...
    CvrApi.prototype.searchByPhone = function (phone) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.execute(this.getUrl(phone, 'phone'))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
